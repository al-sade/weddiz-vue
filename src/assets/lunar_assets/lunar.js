    ...
    proxyWrapper: function () {
      ...
      jQuery('.lunar-gallery-ui').each(function (indx) {
        ...
        jQuery(this).children().each(function (index) {
          ...
          lunarAlbumDta.coverImages = {
            albumCoverLarge: coverImg,
            albumCoverMedium: coverImg,
            albumCoverSmall: coverImg
          }
  ...
  this.addEvents = function () {
    ...
    this.el.hover(function (e) {
      if (_self.el.width() > maxWidthHoverEfx) {
        ...
        TweenMax.to(jQuery(this).find('.lnTitle'), infoTime, {
          css: {bottom: jQuery(this).find('.lnInfo').height() + 30},
          ease: EfxInfo
        })
      ...
      if (_self.el.width() > maxWidthHoverEfx) {
        ...
        TweenMax.to(jQuery(this).find('.lnInfo'), infoTime, {
          css: {bottom: -(jQuery(this).find('.lnInfo').height() + 30)},
          ease: EfxInfo
        })
      ...
      if (_self._model._data.previewVideoURL) {
        if (!_self._model._data.previewVideoAllTime) {
          _self._playerUI.css('display', 'block')
          TweenMax.to(_self._playerUI, .2, {
            css: {opacity: 0}, ease: Power4.easeIn, onComplete: function () {
...
SakuraPlugins.LunarGallery.GalleryView = function (model, elView) {
  ...
  this.moveContentUP = function () {
    ...
    TweenMax.to(this.lunarGalleryContent, .8, {
      css: {top: currentTop - (jQuery(window).height() / 1.5)}, ease: Power1.easeIn, onComplete: function () {
  ...
  this.checkMobileScroll = function () {
    ...
    if ((currentTop + hgt) < jQuery(window).height()) {
      if (jQuery(window).height() > this.lunarGalleryContent.height()) {
        ...
        TweenMax.to(this.lunarGalleryContent, .2, {
          css: {top: -(this.lunarGalleryContent.height() - jQuery(window).height())},
          ease: Power1.easeIn
        })
      }
    }
  ...
  this.render = function () {
    ...
    TweenMax.to(this.el, .5, {
      css: {height: '100%', top: '0px'}, delay: .3, ease: Quad.easeInOut, onComplete: function () {
...
SakuraPlugins.LunarGallery.GalleryItemView = function (model) {
  ...
  this.render = function (parrent) {
    ...
    img.bind('load', function () {
      ...
      if (!SK_LUNAR.isMobile) {
        _self._parrent.parent().niceScroll({
          cursorcolor: '#00F',
          horizrailenabled: false,
          cursorborder: '1px solid #323231',
          cursorcolor: '#212121'
        })
      } else {
  ...
  this.destroy = function () {
    ...
    try {
      ...
      TweenMax.to(this.el.find('.lunarGalleryItemPerspectiveUI'), .5, {
        css: {
          scale: .7,
          opacity: 0,
          rotationY: this.perspectiveUngleAC[randomIntFromInterval(0, 9)],
          rotationX: this.perspectiveUngleAC[randomIntFromInterval(0, 9)]
        }, ease: Quad.easeInOut, onComplete: function () {
          _self.el.remove()
  ...
  this.decorate = function (dataObj) {
    ...
    for (var i = 0; i < dataObj.length; i++) {
      data.push({
        imageLargeURL: this._getOptimiziedImageLightbox(dataObj[i].imageSizes),
        type: (dataObj[i].isVideo == 'false') ? 'image' : 'video',
        extraData: ''
      })
    }
...
function LightBoxLunarClass () {
  ...
  this.init = function (data, advanced, websiteWrapper, startIndx) {
    ...
    TweenMax.to(lightboxUI, .1, {
      css: {opacity: 1, width: '100%', left: 0, height: '100%', top: 0}, ease: Power4.EaseIn, onComplete: function () {
    ...
    function lightboxClose () {
      ...
      if (advanced) {
        ...
        TweenMax.to(websiteWrapper, .2, {
          css: {opacity: 1, scale: 1}, delay: .1, ease: Power4.EaseIn, onComplete: function () {
            lightboxUI.remove()
          }
        })
      } else {
        if (currentImageUI != null) {
          TweenMax.to(currentImageUI, .1, {
            css: {opacity: 0, scale: .8}, ease: Power4.EaseIn, onComplete: function () {
              TweenMax.to(lightboxUI, .2, {
                css: {opacity: 0}, delay: .2, ease: Power4.EaseIn, onComplete: function () {
                  lightboxUI.remove()
                }
              })
            }
